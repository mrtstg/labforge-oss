...
- После успешной установки системы на хосты будет установлен файловый агент Proxmox. [Подробнее](./postinstall.md)
...
3. Работа файлового агента Proxmox
4. Тестирование общего функционала Labforge
